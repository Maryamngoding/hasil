...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
 ...
 <a href="frm_tambah_inventaris.php" class="btn btn-sm btn-primary">Tambah
Data</button></a>
 <br> <br>
...
id="example" style="width:100%">
 ...
 <th scope="col">id_pegawai</th>
  <th scope="col">tgl_inventaris</th>
 ...
 <td><?php echo $rs['id_ruangan']; ?></td>
 <td><?php echo $rs['id_pegawai']; ?></td>
 <td><?php echo $rs['tgl_inventaris']; ?></td>
 <td>
 <a href="frm_ubah_data_inventaris.php?id_inventaris=<?=
$rs['id_inventaris']; ?>"
 class="btn btn-info btn-sm">Ubah</a>
 <a href="hapus_data_inventaris.php?id_inventaris=<?=
$rs['id_inventaris']; ?>"" class=" btn btn-danger
 btn-sm">Hapus</a>
 </td>
 </tr>
 <?php
