...
$id = $_GET['id_barang'];
$queri = mysqli_query($koneksi, "SELECT * FROM tbl_barang where id_barang");
...
$rs['nama_barang']; ?>" class="form-control">
 ...
 <input type="text" name="jumlah_barang" value="<?php echo
$rs['jumlah_barang']; ?>" class="form-control">
 </div>
 <div class="mb-3">
 <label for="exampleFormControlTextarea1" class="formlabel">Tgl Masuk Barang</label>
 <input type="text" name="tgl_masuk_barang" value="<?php echo
$rs['tgl_masuk_barang']; ?>" class="form-control">
 </div>
 <div class="mb-3">
