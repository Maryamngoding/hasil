...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Inventaris</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../admin/data_pegawai.php">
                                <span data-feather="file"></span>
                                Data Pegawai
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../admin/data_barang.php">
                                <span data-feather="shopping-cart"></span>
                                Data Barang
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../admin/data_ruangan.php">
                                <span data-feather="shopping-cart"></span>
                                Data Ruangan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../admin/data_inventaris.php">
                                <span data-feather="shopping-cart"></span>
                                Data Inventaris
                            </a>
                        </li>
